...
export interface AddressData {
  ...
  field_map: [
    ...
    { input_name: 'city'; raw_value: string; label: 'City' },
    { input_name: 'state'; raw_value: string; label: 'State' },
    { input_name: 'zip'; raw_value: string; label: 'Zip' }
  ];
}
...
interface ApplicationData {
  ...
  plugin_GNx0C6: {
    ...
    field_map: [
      ...
      { input_name: 'ip_address'; raw_value: string; label: 'Sign Here' },
      { input_name: 'referrer_url'; raw_value: string; label: 'Sign Here' },
      { input_name: 'agent_type'; raw_value: string; label: 'Sign Here' },
      { input_name: 'agent_name'; raw_value: string; label: 'Sign Here' },
      {
  ...
  select_figLKP: {
    ...
    raw_value: 'Months' | 'Years' | null; // null only for test entries
  ...
  plugin_LsXiVv: { input_name: 'plugin_LsXiVv'; raw_value: null; label: 'SQFTOK' };
  textarea_RDNJmm: {
